	...
	_In_ int       nCmdShow)
{
	...
	wcex.lpszClassName = (LPCWSTR)"HelloWorldClass";
	wcex.hIconSm = wcex.hIcon;
	RegisterClassEx(&wcex);

	hWnd = CreateWindow((LPCWSTR)"HelloWorldClass", (LPCWSTR)"Hello, ksis!",
	...
	WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDBLCLK:
		...
		MessageBox(hWnd, (LPCWSTR)"Hello, World!", (LPCWSTR)"Message", MB_OK);
		break;
