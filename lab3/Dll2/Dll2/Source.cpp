...
extern "C" int __declspec(dllexport) _stdcall changestr(LPVOID pointer)
{
	PARAMS *paramsPointer = (PARAMS*)pointer;
	PARAMS myParams = *paramsPointer;
	char* searchstr = (char*)myParams.oldstr;
	char* newstr = (char*)myParams.newstr;
	int count_symb_to_replace = myParams.count_symb_to_replace;
